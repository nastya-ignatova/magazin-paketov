<?php
   ...
   <div class="a3">
   Все наши пакеты с нулевым углеродным следом. После многократного использования пакета мы рекомендуем сдавать его в переработку или использовать в качестве
       мусорного мешка.
  </div>
